...
using AspNetCoreResourceServerTwo.Repositories;
...
namespace AspNetCoreResourceServerTwo
{
    public class Startup
    {
        ...
        public Startup(IHostingEnvironment env)
        {
            ...
            Log.Logger = new LoggerConfiguration()
                ...
                .Enrich.WithProperty("App", "AspNetCoreResourceServerTwo")
                .Enrich.FromLogContext()
                .WriteTo.Seq("http://localhost:5341")
                .WriteTo.RollingFile("../../Logs/AspNetCoreResourceServerTwo")
                .CreateLogger();
